...
logger.info(
    'Chat API initialized with root_agent=%s',
    product_management_agent.agent.name,
)
...
async def send_message(chat_message: ChatMessage):
    ...
    try:
        ...
        logger.info(
            'POST /api/chat/message session_id=%s root_agent=%s',
            session_id,
            product_management_agent.agent.name,
        )
...
async def stream_message(chat_message: ChatMessage):
    ...
    try:
        ...
        logger.info(
            'POST /api/chat/stream session_id=%s root_agent=%s',
            session_id,
            product_management_agent.agent.name,
        )
